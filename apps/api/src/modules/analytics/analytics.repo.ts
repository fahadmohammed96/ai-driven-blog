 ...
 * then insert the freshly collected ones. This makes re-ingestion **idempotent**
 * (running twice yields the same rows) and keeps one source's data independent of
 * the others. RLS scopes both the delete and the insert to the current tenant.
 */
